...
def test_policy_profile_exports_command_context_input_mode(tmp_path: Path) -> None:
    ...
    assert profile.model.input_mode == "context_command_v1"
    assert env["SORIDORMI_POLICY_INPUT_MODE"] == "context_command_v1"
