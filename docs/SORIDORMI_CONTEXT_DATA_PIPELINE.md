# Soridormi context data pipeline runbook

This runbook is the source-of-truth command order for the context data pipeline locomotion data
...
This wrapper script is useful when you want the context data pipeline to proceed from
