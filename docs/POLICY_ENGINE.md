# Runnable policy engine

runnable policy engine turns the ONNX runtime from a set of scripts into a policy-engine entrypoint.
...
This supports the later replaceable policy interface/training and evaluation backbone/structured body-skill interface flow: model replacement, training, and transfer
to real hardware.
