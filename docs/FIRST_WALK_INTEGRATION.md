# First-walk integration

first-walk integration changes Soridormi from a connected-but-falling policy loop into a closer Open Duck Mini v2 inference compatibility loop.
...
first-walk integration passes if:
